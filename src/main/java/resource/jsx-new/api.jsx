	...
	render() {
		...
		if(this.props.keyword !== '') {
			...
			for(var refKey in this.refs)
				if(this.refs[refKey].isVisible(this.props.keyword) === true) visible = true;
...
var ApiMethodBox = React.createClass({
	isVisible(keyword) {
		...
		var visible = false;
		for(var refKey in this.refs) 
			if(this.refs[refKey].isVisible(keyword) === true) visible = true;
		return visible;
	},
	...
	render() {
		...
		if(this.isVisible(this.props.keyword) === false)
